...
// **POSSIBLE FIX:** Changed `o.overtime_date` to `o.date` in the WHERE clause
$sql = "SELECT
            w.worker_name,
            ll.lead_name,
            j.job_name,
        ...
        WHERE o.date = ? AND o.user_id = ?;"; // Changed to o.date
...
while ($row = $result->fetch_assoc()) {
    ...
    $totalWorkersOvertime++; // Increment for each worker with overtime
    $totalOvertimeHours += $row['overtime_hours']; // Sum up overtime hours
}
