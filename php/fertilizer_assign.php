<?php
# fertilizer_assign.php - Assign Fertilizer Page with Team Lead (Required and on Top)
...
$current_date = date('F j, Y'); // Date format like "March 5, 2025"
...
<head>
    ...
    <style>
        /* Basic form styles - consistent with previous styles */
        .form-container { padding: 20px; }
        .form-group { margin-bottom: 15px; }
        .form-group label { display: block; margin-bottom: 5px; }
        .form-group input[type="text"], .form-group input[type="number"], .form-group select, .form-group input[type="date"] { width: calc(100% - 22px); padding: 8px; border: 1px solid #ccc; border-radius: 4px; }
...
<div class="container form-container">
    ...
    <form id="assignFertilizerFormElement">
        ...
        <div class="modal-actions">
            <button type="button" onclick="window.location.href='fertilizer_mgmt.php'" class="cancel-button" id="cancelAssignFertilizerButton">Cancel</button>
