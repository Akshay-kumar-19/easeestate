...
<script>
    //  JavaScript functions to handle coffee lot management
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        sellCoffeeButton.addEventListener('click', openSellCoffeeLotsForm); // Event listener for Sell Coffee Lot button
        summaryButton.addEventListener('click', openCoffeeSummarySection); // Event listener for Summary button
    ...
    function openCoffeeModal() {
        ...
        document.getElementById('addCoffeeButton').style.display = 'none'; // Hide Add button when form is open
        document.getElementById('sellCoffeeButton').style.display = 'none'; // Hide Sell button when form is open
        document.getElementById('sellCoffeeLotsForm').style.display = 'none'; // Ensure Sell Lots Form is hidden
        document.getElementById('summaryButton').style.display = 'none'; // Hide Summary button
        document.getElementById('coffeeSummarySection').style.display = 'none'; // Ensure Summary Section is hidden
    ...
    function closeCoffeeModal() {
        ...
        document.getElementById('addCoffeeButton').style.display = 'block'; // Show Add button when form is closed
        document.getElementById('sellCoffeeButton').style.display = 'block'; // Show Sell button when form is closed
    ...
    function openCoffeeSummarySection() {
        ...
        document.getElementById('addCoffeeForm').style.display = 'none'; // Ensure Add Form is hidden
        document.getElementById('sellCoffeeLotsForm').style.display = 'none'; // Ensure Sell Lots Form is hidden
        loadCoffeeSummary(); // Load summary when section is opened, default to total summary
    }
    ...
    function loadCoffeeSummary() {
        ...
        document.getElementById('coffeeSummary').innerHTML = '<p>Loading summary...</p>'; // Reset loading message

        fetch(`coffee_summary.php?${params}`) // Path to your coffee_summary.php file, now with parameters
            .then(response => response.json())
            .then(data => {
                ...
                if (data.status === 'success') {
                    ...
                    summaryHTML += `<p><strong>Parchment Coffee:</strong></p>`; // Parchment Details Heading
                    summaryHTML += `<ul>
                    ...
                    summaryHTML += `<p><strong>Cherry Coffee:</strong></p>`; // Cherry Details Heading
                    summaryHTML += `<ul>
            ...
            .catch(error => {
                ...
                document.getElementById('coffeeSummary').innerHTML = `<p>Error loading summary. See console for details.</p>`;
            });
    }
